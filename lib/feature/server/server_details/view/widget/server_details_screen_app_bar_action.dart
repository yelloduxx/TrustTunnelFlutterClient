...
class ServerDetailsScreenAppBarAction extends StatelessWidget {
  ...
  void _showDeleteDialog(BuildContext context, {required String serverName}) {
    final bloc = context.read<ServerDetailsBloc>();
    showDialog(
      context: context,
      builder: (_) => ServerDetailsDeleteDialog(
        onDeletePressed: () => _onDeleteServerSubmit(bloc: bloc),
  ...
  void _onDeleteServerSubmit({
    required ServerDetailsBloc bloc,
  }) =>
      bloc.add(
